                ...
                <div class="page-container">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start">
                            <script>document.write(new Date().getFullYear())</script> © Zenity - By <span class="fw-bold text-decoration-underline text-uppercase text-reset fs-12">BAKA</span>
                        </div>
                        <div class="col-md-6">
...
<!-- Mirrored from coderthemes.com/abstack/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 05:13:46 GMT -->
</html>